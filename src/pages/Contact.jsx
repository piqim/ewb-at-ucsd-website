...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) { alert('Message sent!'); form.reset(); }
          ...
          <div>
            ...
            <div className="space-y-5 text-gray-600 text-sm">
              ...
              <div>
                ...
                <a href="https://www.instagram.com/ewb.at.ucsd/" target="_blank" rel="noopener noreferrer" className="text-ewb-blue hover:underline">
                  @ewb.at.ucsd
                </a>
              </div>
              <div>
