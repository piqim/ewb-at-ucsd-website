  ...
  return (
    ...
    <section className="bg-white py-16 px-4">
      ...
      <div className="max-w-4x1 mx-auto text-center">
        ...
        <h2 className="text-3x1 font-bold ucsd-navy mb-4">Stay Connected</h2>
        ...
        <div className="md_flex-row flex flex-col md:flex-row gap-6 justify-center items-stretch">
          ...
          <div className="max-w-sm mx-auto flex-1">
            <iframe
              ...
              className="rounded-x1 shadow-sm"
          ...
          <div className="flex-1 max-w-sm mx-auto w-full">
            ...
            >
              ...
              <div className="w-16 h-16 rounded-full -gradient-to-br from-purple-500 via-pink-500 to-orange-400 flex items-center justify-center text-white">
